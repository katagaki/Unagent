...
class UserAgentTableViewController: UITableViewController, UITextViewDelegate {
    ...
    var data: [UserAgent] = [UserAgent(name: "Default (Don't Change)",
                             ...
                             UserAgent(name: "Googlebot",
                                       imageName: "Google",
                                       userAgent: "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)"),
                             UserAgent(name: "Bingbot",
                                       imageName: "Bing",
                                       userAgent: "Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)"),
                             UserAgent(name: "Playstation 5",
                                       imageName: "Playstation5",
                                       userAgent: "Mozilla/5.0 (PlayStation 5 5.71) AppleWebKit/601.2 (KHTML, like Gecko)"),
                             UserAgent(name: "Playstation 4",
                                       imageName: "Playstation",
                                       userAgent: "Mozilla/5.0 (PlayStation 4 2.57) AppleWebKit/537.73 (KHTML, like ED32B)"),
                             UserAgent(name: "Playstation Portable",
                                       imageName: "Playstation",
                                       userAgent: "Mozilla/5.0 (PSP (PlayStation Portable); 2.00)"),
                             UserAgent(name: "Xbox",
                                       imageName: "Xbox",
                                       userAgent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.74 Safari/537.36 Xbox Live Client/2.0.17003.0"),
